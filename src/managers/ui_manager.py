...
from utils.constants import (ElementSize, Files, Text, WindowSize, Colors, 
                           Style, Theme, Timing)
...
class UIManager:
    ...
    def _setup_window_properties(self):
        ...
        self.parent.setMinimumSize(WindowSize.COMPACT_WIDTH, WindowSize.COMPACT_HEIGHT)
    ...
    def _create_input_section(self):
        ...
        self.stt_button.setFixedSize(ElementSize.SETTINGS_BUTTON_SIZE, ElementSize.SETTINGS_BUTTON_SIZE)
        ...
        self.settings_button.setFixedSize(ElementSize.SETTINGS_BUTTON_SIZE, ElementSize.SETTINGS_BUTTON_SIZE)
