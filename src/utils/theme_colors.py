...
class ThemeColors:
    ...
    def get_all_themes():
        ...
        """
        ThemeColors._get_dark_theme()
        themes = {
            Theme.CLASSIC: ThemeColors._get_light_theme(),
            # Theme.DARK: Themes._get_dark_theme(),
            # Theme.NATURE: Themes._get_nature_theme(),
        }
        return themes
    ...
    def _get_dark_theme():
        ...
        return {
            ...
            'button_secondary_hover': '#2d3142',
            'button_secondary_active': '#1a1d29',
